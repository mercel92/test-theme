<div id="page-my-price-alarms" class="col-12" v-cloak>
    <div class="row" v-if="!LOADING">
        <div class="col-12 mb-1">
            <div class="d-flex align-items-flex-start justify-content-between">
                <h1 class="d-flex align-items-center">
                    <i class="ti-bell-o text-white member-menu-icon d-flex align-items-center justify-content-center"></i>
                    {#block_title#}
                </h1>
        ...
        <div class="col-12 price-alarm-list" v-if="DATA.PRODUCTS.length > 0">
            <div class="col-12 mb-1 border border-round price-alarm-item" v-for="(PRODUCT, index) in DATA.PRODUCTS">
