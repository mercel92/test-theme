    ...
    <form action="#" id="login-form" method="POST" class="col-12 py-1 bg-white" data-toggle="login-form" data-prefix="popup-" data-callback="ugMemberPopupLoginFn" novalidate>
        ...
        <div class="w-100 d-flex flex-wrap justify-content-between">
            <div class="mb-1">
                ...
                <label class="d-flex align-items-center m-0" for="popup-remember">
            ...
            <div class="mb-1">
                <a href="/{url type='page' id='7'}" class="text-body">{#forgot_password#}</a>
            </div>
        </div>
        <div class="w-100">
            <div class="row">
                ...
                <div class="col-12" v-if="SETTING.DISPLAY_FACEBOOK == 1 || SETTING.DISPLAY_GOOGLE == 1 || SETTING.DISPLAY_APPLE == 1">
                    <div class="row">
                        <div class="col-4 mb-1" v-if="SETTING.DISPLAY_FACEBOOK == 1">
                            <a href="/srv/service/social/facebook/login" class="fb-login-btn">
                                <i class="ti-facebook"></i> {#connect_with#}
                            </a>
                        </div>
                        <div class="col-4 mb-1" v-if="SETTING.DISPLAY_GOOGLE == 1">
                            <a id="signinGoogle" href="javascript:void(0)" class="google-login-btn">
                                <i class="ti-google"></i> {#connect_with#}
                            </a>
                        </div>
                        <div class="col-4 mb-1" v-if="SETTING.DISPLAY_APPLE == 1">
...
<script>
    ...
    const popupLogin = {
        data() {
            return {
                SETTING: {
                    LICENCE_REGISTRATION_WITH_PHONE: 0,
                    DISPLAY_FACEBOOK: 0,
                    DISPLAY_GOOGLE: 0,
                    DISPLAY_APPLE: 0
                }
