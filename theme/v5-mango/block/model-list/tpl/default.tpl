...
<div class="col-12 col-md-10">
    <div class="row mb-1">
        <div class="col-12">
            <h1 class="block-title no-line mb-1">{#model_search#}</h1>
            <form class="form-search w-100 position-relative mb-2" id="form-search-{$BLOCK.ID}">
                <input id="search-word-{$BLOCK.ID}" name="search" type="search" placeholder="{#enter_model#}" value="{$SEARCH_WORD}" class="form-control form-control-md no-cancel" {if $SEARCH_WORD == ''}required{/if}>
