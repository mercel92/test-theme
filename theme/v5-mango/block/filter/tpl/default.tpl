...
<div id="product-filter" class="col-12" data-position="left" v-cloak>
    ...
    <div class="row mx-0 mb-2" v-if="!LOADING">
            ...
            <div class="row">
                ...
                <div class="col-12 filter-body accordion-body show">
                    ...
                    <div class="mt-1" v-if="FILTERS.SELECTED.length > 1">
                        <button type="button" class="btn btn-sm btn-gray" @click="clearFilter('all')">{#clear_all_filter#}</button>
                    </div>
                </div>
        </section>
        ...
        <!--<div class="col-12">
            <div class="row">
                <button type="button" class="w-100 btn btn-primary text-uppercase d-flex justify-content-between" @click="run">{#filter_click#} <i class="ti-arrow-right"></i></button>
            </div>
        </div>-->
    </div>
</div>