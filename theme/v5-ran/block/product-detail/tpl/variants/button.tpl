<div class="row">
    {foreach from=$SUB_LIST item=SUB name=variant}
        <div class="col-auto mb-1">
            ...
            data-toggle="variant"
                class="d-block border sub-button-item{if $SUB.TYPE_ID == $SELECTED && $IS_DEFAULT_VARIANT_ACTIVE|default:1 == 1} selected{/if}{if $SUB.IN_STOCK == false && $NEGATIVE_STOCK == 0} passive{/if}">
                <span>{$SUB.TYPE}</span>
            </a>
        </div>
    {/foreach}
