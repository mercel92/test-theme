const thumbs = new Swiper(`#slider-thumb-${BLOCK.ID}`, {
    ...
    breakpoints: {
        576: {
            slidesPerView: 8,
            spaceBetween: SETTING.MARGIN.SM == '0' || '' ? '15' : SETTING.MARGIN.SM,
        },
        768: {
            slidesPerView: 10,
            spaceBetween: SETTING.MARGIN.MD == '0' || '' ? '15' : SETTING.MARGIN.MD,
        },
        992: {
            slidesPerView: 10,
            spaceBetween: SETTING.MARGIN.LG == '0' || '' ? '15' : SETTING.MARGIN.LG,
        },
        1170: {
            slidesPerView: 12,
            spaceBetween: SETTING.MARGIN.XL == '0' || '' ? '15' : SETTING.MARGIN.XL,
        },
    },
});
