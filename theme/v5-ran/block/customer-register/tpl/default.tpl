    ...
    <div class="col-12 my-1" v-if="!LOADING">
        <div class="row">
            <div class="col-12 col-md-6 mb-2" :class="{ 'mx-auto' : IS_MEMBER_LOGGED_IN !== true }">
                <form action="#" method="POST" enctype="multipart/form-data" autocomplete="off" class="w-100 py-1 bg-white border border-light border-round" :class="{ 'p-2' : IS_MEMBER_LOGGED_IN !== true }"
                    :id="'member-register-form' + BLOCK.ID" ref="memberRegister" @submit.prevent="saveForm" novalidate>
                    <div class="col-12 mb-2" v-if="IS_MEMBER_LOGGED_IN !== true">
                    ...
                    <div class="col-12 mb-1" v-for="(FIELD, index) in FORM_FIELDS.block">
                        ...
                        <div class="w-100 popover-wrapper position-relative" v-else-if="FIELD.key == 'identity_number'">
                            ...
                            <div class="h-100 d-flex align-items-center pr-1 position-absolute nationality-field-wrapper" v-if="FORM_FIELDS.block.find(x => x.key == 'nationality')">
                                ...
                                <label for="nationality" class="p-0 m-0 fw-regular" id="label-nationality">
                        ...
                        <div class="w-100 popover-wrapper position-relative" v-else-if="FIELD.key.substring(0, 5) == 'file_'">
                            ...
                            <label :for="FIELD.key" :id="'label-' + FIELD.key" class="form-control form-control-md d-flex align-items-center justify-content-between text-content fw-regular">
                                <span>{#file#}</span>
                        ...
                        <div class="w-100 popover-wrapper position-relative" v-else-if="FIELD.type == 'RADIO'">
                            <label class="fw-regular">{{ FIELD.field }}</label>
                        ...
                        <div class="w-100 popover-wrapper position-relative" v-else-if="FIELD.type == 'CHECK_BOX'">
                            ...
                            <div class="clearfix checkbox-button-group d-flex align-items-center flex-wrap">
                                <div class="group-item" :class="{ 'mr-1' : index + 1 < FIELD.options.length }" v-for="(OPT, index) in FIELD.options">
                                    <input type="checkbox" :name="FIELD.key + '[]'" :id="FIELD.key + '_' + index" :value="OPT" class="form-control fw-regular">
                    ...
                    <div class="w-100" v-if="IS_MEMBER_LOGGED_IN === false">
                        <div class="col-12 mb-1">
                            <div class="w-100 popover-wrapper position-relative">
                                ...
                                <label :for="'mail_notify_' + BLOCK.ID" :id="'label_mail_notify_' + BLOCK.ID" class="fw-regular">
                                    <span class="input-checkbox">
                                        <i class="ti-check"></i>
                                    </span>
                                    {#send_info#} <a :href="FORM_FIELDS.pageData.emailContactUrl" class="text-primary popupwin">{#email#}</a> {#get#}
                                </label>
                            </div>
                        </div>
                        <div class="col-12 mb-1">
                            <div class="w-100 popover-wrapper position-relative">
                                ...
                                <label :for="'sms_notify_' + BLOCK.ID" :id="'label_sms_notify_' + BLOCK.ID" class="fw-regular">
                                    <span class="input-checkbox">
                                        <i class="ti-check"></i>
                                    </span>
                                    {#send_info#} <a :href="FORM_FIELDS.pageData.smsContactUrl" class="text-primary popupwin">sms</a> {#get#}
                                </label>
                            </div>
                        </div>
                        <div class="col-12 mb-1">
                            <div class="w-100 popover-wrapper position-relative">
                                ...
                                <label :for="'phone_notify_' + BLOCK.ID" :id="'label_phone_notify_' + BLOCK.ID" class="fw-regular">
                                    <span class="input-checkbox">
                                        <i class="ti-check"></i>
                                    </span>
                                    {#send_info#} <a :href="FORM_FIELDS.pageData.phoneContactUrl" class="text-primary popupwin">{#call#}</a> {#get#}
                                </label>
                            </div>
                        </div>
                        <div class="col-12 mb-1" v-if="FORM_FIELDS.pageData.displayPrivacy">
                            <div class="w-100 popover-wrapper position-relative">
                                ...
                                <label :for="'privacy_' + BLOCK.ID" :id="'label_privacy_' + BLOCK.ID" class="fw-regular">
                                    <span class="input-checkbox">
                                        <i class="ti-check"></i>
                                    </span>
                                    <a :href="FORM_FIELDS.pageData.membershipUrl" class="text-primary popupwin">{#membership#}</a> {#accept#}.
                                </label>
                            </div>
                        </div>
                        <div class="col-12 mb-1" v-if="FORM_FIELDS.pageData.displayKvkk">
                            <div class="w-100 popover-wrapper position-relative">
                                ...
                                <label :for="'kvkk_' + BLOCK.ID" :id="'label_kvkk_' + BLOCK.ID" class="fw-regular">
                                    <span class="input-checkbox">
                                        <i class="ti-check"></i>
                                    </span>
                                    <a :href="FORM_FIELDS.pageData.kvkkUrl" class="text-primary popupwin">{#kvkk#}</a> {#accept#}.
                                </label>
                            </div>
                        </div>
                    </div>
