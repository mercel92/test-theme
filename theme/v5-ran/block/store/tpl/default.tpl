<div class="col-12 my-2">
    ...
    <div class="row">
        ...
        <div class="col-12 mb-1 fs-18">{#results_total#} <span class="text-primary fw-bold">{$STORE_LIST|@count} {#store#}</span> {#listed#}</div>
        {else}
        <div class="col-12 mb-1 fs-18">{#no_result#}</div>
        {/if}
                                    ...
                                    <div class="row mb-2">
                                        {if $S.ADDRESS}
                                            <div class="col-12 col-sm-6 col-md-4">
                                                <div>{#address#}</div>
                                                <div class="text-gray">{$S.ADDRESS}</div>
                                            </div>
                                        {/if}
                                        {if $S.PHONE}
                                            <div class="col-12 col-sm-6 col-md-4">
                                                <div>{#phone#}</div>
                                                <div class="text-gray">{$S.PHONE}</div>
                                            </div>
                                        {/if}
                                    </div>
                                {/if}
                                {if $S.FAX || $S.EMAIL}
                                    <div class="row mb-2">
                                        {if $S.FAX}
                                            <div class="col-12 col-sm-6 col-md-4">
                                                <div>{#fax#}</div>
                                                <div class="text-gray">{$S.FAX}</div>
                                            </div>
                                        {/if}
                                        {if $S.EMAIL}
                                            <div class="col-12 col-sm-6 col-md-4">
                                                <div>{#email#}</div>
                                                <div class="text-gray">{$S.EMAIL}</div>
                                            </div>
                                        {/if}
                                    </div>
                                {/if}
